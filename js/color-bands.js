...
// previews in the loaded Filament 1, so the readout surfaces this shade for the
// user to load/set first. (Auto-setting it works only via a project
// Slic3r_PE.config, whose mere presence flips PrusaSlicer into full-project mode:
// it then honors the file's corner object positions and defaults every
// unspecified print setting. Not worth it for a cosmetic base preview.)
